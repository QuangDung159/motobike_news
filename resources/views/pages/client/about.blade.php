...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="{{$URL_CLIENT_ASSET}}/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom fonts for this template -->
    <link href="https://fonts.googleapis.com/css?family=Saira+Extra+Condensed:500,700" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Muli:400,400i,800,800i" rel="stylesheet">
    <link href="{{$URL_CLIENT_ASSET}}/vendor/fontawesome-free/css/all.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="{{$URL_CLIENT_ASSET}}/css/resume.min.css" rel="stylesheet">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link js-scroll-trigger" href="home">Back to Homepage</a>
            </li>
        </ul>
    </div>
</nav>
...
<script src="{{$URL_CLIENT_ASSET}}/vendor/jquery/jquery.min.js"></script>
<script src="{{$URL_CLIENT_ASSET}}/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

<!-- Plugin JavaScript -->
<script src="{{$URL_CLIENT_ASSET}}/vendor/jquery-easing/jquery.easing.min.js"></script>

<!-- Custom scripts for this template -->
<script src="{{$URL_CLIENT_ASSET}}/js/resume.min.js"></script>
