...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="{{$URL_ADMIN_ASSET}}/bower_components/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">

    <!-- MetisMenu CSS -->
    <link href="{{$URL_ADMIN_ASSET}}/bower_components/metisMenu/dist/metisMenu.min.css" rel="stylesheet">
